...
> A **reviewer** agent (structured, calibrated code review) and a **scribe** agent (grounded files/docs work —
> reads, creates & converts PDF/DOCX/XLSX/PPTX/HTML/CSV and OCRs images). Interactive **`chorale tui`**. Model **profiles** +

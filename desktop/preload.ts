...
const bridge: ChoraleBridge = {
  ...
  listModels: (provider) => ipcRenderer.invoke(IPC.modelsList, provider),
  setModelChain: (chain) => ipcRenderer.invoke(IPC.modelChainSet, chain),
  setConfigValue: (block, key, value) => ipcRenderer.invoke(IPC.configSetValue, block, key, value),
